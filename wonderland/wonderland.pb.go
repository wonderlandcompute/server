...
func (Job_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_wonderland_862ae73b7c7fcd1b, []int{0, 0}
}
...
func (*Job) Descriptor() ([]byte, []int) {
	return fileDescriptor_wonderland_862ae73b7c7fcd1b, []int{0}
}
...
func (*ListOfJobs) Descriptor() ([]byte, []int) {
	return fileDescriptor_wonderland_862ae73b7c7fcd1b, []int{1}
}
...
func (dst *ListOfJobs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListOfJobs.Merge(dst, src)
}
...
func (*RequestWithId) Descriptor() ([]byte, []int) {
	return fileDescriptor_wonderland_862ae73b7c7fcd1b, []int{2}
}
...
func (dst *RequestWithId) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestWithId.Merge(dst, src)
}
...
func (*ListJobsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_wonderland_862ae73b7c7fcd1b, []int{3}
}
...
func (*FetchJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_wonderland_862ae73b7c7fcd1b, []int{4}
}
...
func (dst *FetchJob) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FetchJob.Merge(dst, src)
}
...
func (m *FetchJob) GetCursor() string {
	if m != nil {
		return m.Cursor
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*FetchJob)(nil), "FetchJob")
...
type WonderlandClient interface {
	...
	FetchJobs(ctx context.Context, in *FetchJob, opts ...grpc.CallOption) (Wonderland_FetchJobsClient, error)
	FetchAll(ctx context.Context, in *ListJobsRequest, opts ...grpc.CallOption) (*ListOfJobs, error)
}
...
func (c *wonderlandClient) FetchJobs(ctx context.Context, in *FetchJob, opts ...grpc.CallOption) (Wonderland_FetchJobsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Wonderland_serviceDesc.Streams[0], "/Wonderland/FetchJobs", opts...)
	if err != nil {
		return nil, err
	}
	x := &wonderlandFetchJobsClient{stream}
...
type Wonderland_FetchJobsClient interface {
	Recv() (*Job, error)
	grpc.ClientStream
}

type wonderlandFetchJobsClient struct {
	grpc.ClientStream
}

func (x *wonderlandFetchJobsClient) Recv() (*Job, error) {
	m := new(Job)
...
func (c *wonderlandClient) FetchAll(ctx context.Context, in *ListJobsRequest, opts ...grpc.CallOption) (*ListOfJobs, error) {
	out := new(ListOfJobs)
	err := c.cc.Invoke(ctx, "/Wonderland/FetchAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WonderlandServer interface {
	...
	FetchJobs(*FetchJob, Wonderland_FetchJobsServer) error
	FetchAll(context.Context, *ListJobsRequest) (*ListOfJobs, error)
}
...
func _Wonderland_FetchJobs_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(FetchJob)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(WonderlandServer).FetchJobs(m, &wonderlandFetchJobsServer{stream})
}

type Wonderland_FetchJobsServer interface {
	Send(*Job) error
	grpc.ServerStream
}

type wonderlandFetchJobsServer struct {
	grpc.ServerStream
}

func (x *wonderlandFetchJobsServer) Send(m *Job) error {
	return x.ServerStream.SendMsg(m)
}

func _Wonderland_FetchAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListJobsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WonderlandServer).FetchAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Wonderland/FetchAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WonderlandServer).FetchAll(ctx, req.(*ListJobsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Wonderland_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FetchAll",
			Handler:    _Wonderland_FetchAll_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "FetchJobs",
			Handler:       _Wonderland_FetchJobs_Handler,
			ServerStreams: true,
		},
	},
...
func init() { proto.RegisterFile("wonderland.proto", fileDescriptor_wonderland_862ae73b7c7fcd1b) }

var fileDescriptor_wonderland_862ae73b7c7fcd1b = []byte{
	// 466 bytes of a gzipped FileDescriptorProto
	,
}
